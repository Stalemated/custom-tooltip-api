...
public class TagStrategy implements TargetMatcher {
    ...
    public TagStrategy(String tagId) { this.tagKey = TagKey.of(RegistryKeys.ITEM, new Identifier(tagId)); }

    @Override public boolean matches(ItemStack stack) { return stack.isIn(tagKey); }
}
